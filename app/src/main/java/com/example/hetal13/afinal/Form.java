...
//        // send button onclick method
    ...
    public void setList(ListView list_View) {
        // set adapter and data in model class
        Log.v("setlist", "");
        final ArrayList<Comment_Model> commentlist = new ArrayList<Comment_Model>();
//        commentlist.add(new Comment_Model("Meghna","hello"));
//        commentlist.add(new Comment_Model("Bhoomi","hello"));
//        commentlist.add(new Comment_Model("Hetal","hello"));
//        commentlist.add(new Comment_Model("Aditi","hello"));
//        commentlist.add(new Comment_Model("Meera","hello"));
//        commentlist.add(new Comment_Model("Dishti","hello"));
//        commentlist.add(new Comment_Model("Ranek","hello"));
//        commentlist.add(new Comment_Model("Nidhi","hello"));
        //commentlist.add(new Comment_Model("Mayuree","hello"));
        //commentlist.add(new Comment_Model("Shraddha","hello"));
